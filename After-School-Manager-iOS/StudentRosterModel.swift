...
class StudentRosterModel {
    ...
    private func getStudentList() {
        ...
        var signedOutSQL = ""
        if (rosterState == 1) {
            //Gets students who are not signed out and attending today
            //Includes students who were marked as special attendance
            ...
            //Gets students who are signed out and attending today
            //Includes students who were marked as special attendance
